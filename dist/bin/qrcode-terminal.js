...
function version() {
    var packagePath = path_1.default.join(__dirname, '..', 'package.json'), packageJSON = JSON.parse(fs_1.default.readFileSync(packagePath).toString());
